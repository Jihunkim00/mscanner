...
class ResultUiCopy {
  ...
  static const String recommendationHeaderFallback = 'recommendationHeaderFallback';
  ...
  static String text(
    ...
    final table = _localized[localeKey] ?? _localized[_languageOnly(localeKey)] ?? _localized['en']!;
  ...
  static const Map<String, Map<String, String>> _localized = {
    'en': {
      ...
      reasonSignature: 'A house signature that usually makes a strong first order.',
      reasonSeafood: 'An easy choice if you want a lighter seafood-forward option.',
      reasonSpicy: 'Great first choice if you want something with a spicy kick.',
      reasonVegan: 'A safe first pick when you want a clean plant-forward option.',
      reasonDietary: 'A practical first pick when you need ingredient-friendly options.',
      reasonGrill: 'A strong first pick if you are in the mood for grilled flavor.',
      reasonStew: 'A reliable choice when you want something warm and comforting.',
      reasonStyleWithLabel: 'A good first pick if you are looking for a {label} style dish.',
    },
    'ko': {
    ...
    'hi': {
      ...
      reasonPopular: 'यह लोकप्रिय पहला विकल्प है, इसलिए चुनना आसान और भरोसेमंद है।',
      reasonSignature: 'यह हाउस सिग्नेचर है, पहली बार के लिए आमतौर पर अच्छा रहता है।',
      ...
      reasonStyleWithLabel: 'अगर आप {label} स्टाइल चाहते हैं, तो यह अच्छा पहला विकल्प है।',
    },
    'es': {
      ...
      reasonSignature: 'Una especialidad de la casa que suele funcionar muy bien al pedir por primera vez.',
      reasonSeafood: 'Una opción fácil si quieres algo más ligero y con enfoque en mariscos.',
      reasonSpicy: 'Gran primera elección si te apetece algo con toque picante.',
      reasonVegan: 'Una primera opción segura si buscas algo más vegetal y ligero.',
      reasonDietary: 'Una opción práctica si necesitas cuidar restricciones de ingredientes.',
      ...
      reasonStyleWithLabel: 'Buena primera opción si buscas un plato de estilo {label}.',
    },
    'fr': {
      ...
      reasonPopular: 'Un premier choix populaire, facile à sélectionner en toute confiance.',
      reasonSignature: 'Une spécialité de la maison, souvent un excellent premier choix.',
      reasonSeafood: 'Un choix facile si vous voulez une option plus légère, orientée fruits de mer.',
      reasonSpicy: 'Très bon premier choix si vous voulez une touche épicée.',
      reasonVegan: 'Un premier choix sûr si vous cherchez une option végétale et légère.',
      reasonDietary: 'Un choix pratique si vous devez tenir compte de contraintes alimentaires.',
      reasonGrill: 'Un bon premier choix si vous avez envie d’une saveur grillée.',
      reasonStew: 'Un choix fiable si vous voulez quelque chose de chaud et réconfortant.',
      reasonStyleWithLabel: 'Un bon premier choix si vous cherchez un plat de style {label}.',
    },
    'vi': {
      ...
      reasonSignature: 'Món đặc trưng của quán, thường là lựa chọn đầu tiên rất ổn.',
      reasonSeafood: 'Dễ chọn nếu bạn muốn vị hải sản nhẹ nhàng hơn.',
      reasonSpicy: 'Lựa chọn đầu tiên tốt nếu bạn muốn vị cay.',
      reasonVegan: 'Lựa chọn an toàn nếu bạn muốn món thanh nhẹ, thiên về thực vật.',
      ...
      reasonStyleWithLabel: 'Lựa chọn đầu tiên tốt nếu bạn đang tìm món kiểu {label}.',
    },
    'th': {
      ...
      reasonStyleWithLabel: 'ถ้าคุณมองหาเมนูสไตล์ {label} นี่เป็นตัวเลือกแรกที่ดี',
    },
    'ar': {
    ...
    'bn': {
      ...
      reasonPopular: 'এটি জনপ্রিয় প্রথম পছন্দ, তাই আত্মবিশ্বাসের সাথে বেছে নেওয়া সহজ।',
      reasonSignature: 'এটি রেস্টুরেন্টের সিগনেচার, প্রথমবারের জন্য ভালো পছন্দ।',
    ...
    'ru': {
      ...
      reasonSignature: 'Фирменное блюдо заведения, обычно отличный первый заказ.',
      reasonSeafood: 'Удобный выбор, если хочется чего-то более лёгкого с морским акцентом.',
      reasonSpicy: 'Отличный первый выбор, если хочется остроты.',
      reasonVegan: 'Безопасный первый выбор, если нужен более лёгкий растительный вариант.',
      reasonDietary: 'Практичный выбор, если важно учитывать ограничения по ингредиентам.',
      ...
      reasonStyleWithLabel: 'Хороший первый выбор, если вы ищете блюдо в стиле {label}.',
    },
    'pt': {
      ...
      reasonPopular: 'Uma primeira escolha popular e fácil de fazer com confiança.',
      reasonSignature: 'Um prato assinatura da casa, geralmente ótimo para o primeiro pedido.',
      reasonSeafood: 'Uma escolha fácil se você quer algo mais leve e com foco em frutos do mar.',
      reasonSpicy: 'Ótima primeira escolha se você quer algo com toque picante.',
      reasonVegan: 'Uma primeira escolha segura se você busca uma opção mais vegetal e leve.',
      reasonDietary: 'Uma escolha prática se você precisa considerar restrições de ingredientes.',
      reasonGrill: 'Boa primeira escolha se você está com vontade de sabor grelhado.',
      reasonStew: 'Uma escolha confiável se você quer algo quente e reconfortante.',
      reasonStyleWithLabel: 'Boa primeira escolha se você procura um prato no estilo {label}.',
    },
    'pt-BR': {
      quickPickBadge: 'Escolha rápida',
      recommendationHeaderFallback: 'Pratos recomendados',
    ...
    'ur': {
      ...
      reasonPopular: 'یہ ایک مقبول پہلا انتخاب ہے جسے اعتماد سے چنا جا سکتا ہے۔',
      reasonSignature: 'یہ ریسٹورنٹ کی خاص ڈش ہے، پہلی بار کے لیے عموماً اچھا انتخاب۔',
      reasonSeafood: 'اگر آپ ہلکا سمندری ذائقہ چاہتے ہیں تو یہ آسان انتخاب ہے۔',
      reasonSpicy: 'اگر آپ مصالحہ دار ذائقہ چاہتے ہیں تو یہ بہترین پہلا انتخاب ہے۔',
      reasonVegan: 'اگر آپ ہلکا پودوں پر مبنی آپشن چاہتے ہیں تو یہ محفوظ انتخاب ہے۔',
      reasonDietary: 'اگر اجزاء کی پابندیوں کا خیال رکھنا ہو تو یہ عملی انتخاب ہے۔',
      ...
      reasonStyleWithLabel: 'اگر آپ {label} انداز کی ڈش چاہتے ہیں تو یہ اچھا پہلا انتخاب ہے۔',
    },
    'id': {
      ...
      reasonPopular: 'Pilihan pertama yang populer dan mudah dipilih dengan yakin.',
      reasonSignature: 'Menu andalan restoran, biasanya cocok untuk pesanan pertama.',
      reasonSeafood: 'Pilihan mudah jika Anda ingin opsi seafood yang lebih ringan.',
      reasonSpicy: 'Pilihan pertama yang bagus jika Anda ingin rasa pedas.',
      reasonVegan: 'Pilihan pertama yang aman jika Anda ingin opsi nabati yang lebih ringan.',
      reasonDietary: 'Pilihan praktis saat Anda perlu mempertimbangkan batasan bahan.',
      reasonGrill: 'Pilihan pertama yang kuat jika Anda sedang ingin rasa panggang.',
      reasonStew: 'Pilihan andal saat Anda ingin menu hangat dan menenangkan.',
      reasonStyleWithLabel: 'Pilihan pertama yang baik jika Anda mencari hidangan gaya {label}.',
    },
    'de': {
      ...
      reasonSignature: 'Ein Signature-Gericht des Hauses und oft eine starke erste Bestellung.',
      reasonSeafood: 'Eine einfache Wahl, wenn Sie etwas Leichteres mit Meeresfrüchten möchten.',
      reasonSpicy: 'Eine gute erste Wahl, wenn Sie etwas mit Schärfe möchten.',
      reasonVegan: 'Eine sichere erste Wahl, wenn Sie etwas Pflanzliches und Leichtes möchten.',
      reasonDietary: 'Eine praktische Wahl, wenn Sie Zutaten-Einschränkungen beachten müssen.',
      reasonGrill: 'Eine starke erste Wahl, wenn Sie Lust auf Grillaroma haben.',
      reasonStew: 'Eine verlässliche Wahl, wenn Sie etwas Warmes und Wohltuendes möchten.',
      reasonStyleWithLabel: 'Eine gute erste Wahl, wenn Sie ein Gericht im {label}-Stil suchen.',
    },
    'mr': {
      ...
      reasonPopular: 'हा लोकप्रिय पहिला पर्याय आहे, त्यामुळे आत्मविश्वासाने निवडता येतो.',
      reasonSignature: 'हा हाऊस सिग्नेचर पदार्थ आहे, पहिल्यांदा ऑर्डरसाठी उत्तम.',
      reasonSeafood: 'हलका सीफूड पर्याय हवा असल्यास ही सोपी निवड आहे.',
      reasonSpicy: 'तिखट चव हवी असल्यास हा उत्तम पहिला पर्याय आहे.',
      reasonVegan: 'हलका वनस्पती-आधारित पर्याय हवा असल्यास ही सुरक्षित निवड आहे.',
      reasonDietary: 'घटकांवरील मर्यादा लक्षात घ्यायच्या असतील तर हा व्यवहार्य पर्याय आहे.',
      reasonGrill: 'ग्रिल्ड चव हवी असल्यास हा मजबूत पहिला पर्याय आहे.',
      reasonStew: 'गरम आणि समाधानकारक काही हवे असल्यास हा विश्वासार्ह पर्याय आहे.',
      reasonStyleWithLabel: '{label} शैलीतील पदार्थ हवा असल्यास ही चांगली पहिली निवड आहे.',
    },
    'te': {
      ...
      reasonPopular: 'ఇది ప్రజాదరణ పొందిన మొదటి ఎంపిక, కాబట్టి నమ్మకంగా ఎంచుకోవచ్చు.',
      reasonSignature: 'ఇది హౌస్ సిగ్నేచర్ వంటకం, మొదటిసారి ఆర్డర్‌కు మంచి ఎంపిక.',
      reasonSeafood: 'తేలికైన సీఫుడ్ ఎంపిక కావాలంటే ఇది సులభమైన నిర్ణయం.',
      reasonSpicy: 'కారం రుచి కావాలంటే ఇది మంచి మొదటి ఎంపిక.',
      reasonVegan: 'తేలికైన ప్లాంట్-ఫార్వర్డ్ ఎంపిక కోరుకుంటే ఇది సురక్షిత ఎంపిక.',
      reasonDietary: 'పదార్థ పరిమితులు చూసుకోవాల్సినప్పుడు ఇది ఉపయోగకరమైన ఎంపిక.',
    ...
    'tr': {
      ...
      reasonSignature: 'Mekânın imza yemeği; ilk sipariş için genelde güçlü bir tercih.',
      reasonSeafood: 'Daha hafif, deniz ürünleri odaklı bir seçenek istiyorsanız kolay bir tercih.',
      reasonSpicy: 'Acı bir tat istiyorsanız harika bir ilk seçim.',
      reasonVegan: 'Daha hafif, bitki ağırlıklı bir seçenek için güvenli bir ilk tercih.',
      reasonDietary: 'İçerik kısıtlarını gözetmeniz gerekiyorsa pratik bir tercih.',
      reasonGrill: 'Izgara lezzeti istiyorsanız güçlü bir ilk seçim.',
      reasonStew: 'Sıcak ve rahatlatıcı bir şey istediğinizde güvenilir bir tercih.',
      reasonStyleWithLabel: '{label} tarzı bir yemek arıyorsanız iyi bir ilk seçim.',
    },
  };
}